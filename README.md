...
(this is part of manuscript "Identification of personalized multi-target therapies against glioblastoma identifies a synergistic interaction between EGFR/HER2/MCL1 and BCL2" Neurooncol Adv. 2023 Jun 13;5(1):vdad073. doi: 10.1093/noajnl/vdad073, which is used here to determine the number of clusters in the synergy data).
